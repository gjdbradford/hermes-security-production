    ...
    },
    {
      ...
      svg: (
        <svg className='w-8 h-8' fill='currentColor' viewBox='0 0 24 24'>
          ...
          <text x='12' y='13' textAnchor='middle' fontSize='12' transform='rotate(90 12 13)'>
            )
          </text>
        </svg>
      ),
        ...
        <div className='max-w-6xl mx-auto text-center'>
          ...
          <div className='max-w-4xl mx-auto mb-16'>
            <p className='text-lg text-gray-600 leading-relaxed'>
              Penetration Testing (Pentest) is a systematic approach to strengthening your security
              by detecting and addressing weaknesses in your digital systems. It mimics real
              cyberattacks to uncover vulnerabilities, assess their potential impact, and prioritize
              fixes. Our testing combines automated tools with hands-on expertise for thorough and
              reliable results.
            </p>
          </div>
