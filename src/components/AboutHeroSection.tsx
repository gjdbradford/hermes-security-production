      ...
      <div className='relative container mx-auto px-6'>
        <div className='max-w-6xl mx-auto text-center'>
          ...
          <p
            ...
            style={{ animationDelay: '0.8s' }}
          >
            We stand at the frontier of cybersecurity, defending humanity's digital future against
            emerging AI threats. Our mission is to ensure technology remains a force for good in an
