...
const stages = [
  {
    ...
    description:
      'We align with your business objectives, set clear rules of engagement, and prepare safe test environments.',
  ...
  },
  {
    ...
    description:
      'Automated asset discovery combined with targeted manual reconnaissance reveals hidden exposures.',
  ...
  },
  {
    ...
    description:
      'AI-assisted exploitation safely chains misconfigurations and flaws, while human experts control depth and safety.',
  ...
  },
  {
    ...
    description:
      'We score vulnerabilities by exploitability × business impact and deliver clear executive + engineering reports, followed by fix validation.',
        ...
        <div id='methodology' className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-hero-muted leading-relaxed max-w-3xl mx-auto'>
              A proven 4-step process that accelerates testing, strengthens compliance, and delivers
