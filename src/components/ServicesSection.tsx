...
const services = [
  ...
  },
  {
    ...
    title: 'API Pentest',
    description:
      'Assess authentication, shadow APIs, injection flaws, and broken object-level access.',
  ...
  },
  {
    ...
    benefit:
      'Understand what attackers see externally and validate internal segmentation controls.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    title: 'AI/LLM',
    description:
      'Adversarial testing for LLMs, agents, and guardrails (prompt injection, data leakage, model abuse).',
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p id='services' className='text-xl text-hero-muted leading-relaxed max-w-3xl mx-auto'>
              Comprehensive penetration testing tailored to your stack, with clear outcomes you can
              act on.
            </p>
            <p className='text-lg text-accent-security font-semibold mt-4'>Core PTaaS Services</p>
          </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12'>
            {services.map((service, index) => (
              ...
              >
                ...
                <p className='text-hero-muted text-sm mb-4 leading-relaxed'>
                  {service.description}
                </p>
                <div className='pt-3 border-t border-hero-foreground/10'>
                  <p className='text-xs font-medium text-accent-security'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>
              <div className='text-center'>
                ...
                <p className='text-sm text-hero-muted'>
                  Prioritised reporting by exploitability × impact
                </p>
              </div>
              <div className='text-center'>
                <div className='w-12 h-12 bg-accent-security/20 rounded-lg flex items-center justify-center mx-auto mb-3'>
              ...
              <div className='text-center'>
                ...
                <p className='text-sm text-hero-muted'>
                  Aligned with OWASP, NIST, ISO 27001, PCI DSS, and SOC 2
                </p>
              </div>
            </div>
          </div>
