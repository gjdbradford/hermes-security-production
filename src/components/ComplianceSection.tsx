        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-hero-muted leading-relaxed max-w-3xl mx-auto'>
              Hermes delivers proven risk reduction and compliance gains from every engagement —
              turning vulnerabilities into measurable improvements in your security posture.
            </p>
          </div>
          ...
          {/* <div className="bg-gradient-security rounded-xl p-8 border border-accent-security/20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {_impactMetrics.map((metric, index) => (
                <div
                  key={index}
