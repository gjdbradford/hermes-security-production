...
const visionMissionData = [
  {
    icon: Eye,
    title: "Our Vision",
    content: "A world where AI serves humanity, not threatens it. We envision a digital landscape where technology amplifies human potential while maintaining the highest standards of security and ethics.",
    highlight: "AI for humanity"
  },
  {
    icon: Target,
    title: "Our Mission",
    content: "To be the shield that protects the digital realm, ensuring technology remains a force for good. We combine AI speed with human wisdom to create unstoppable protection against emerging threats.",
    highlight: "Protecting the digital realm"
  },
  {
    icon: Globe,
    title: "Why It Matters",
    content: "In today's interconnected world, the security of one organization affects us all. AI threats don't discriminate - they target any vulnerability they can find. Our work protects not just our clients, but the entire digital ecosystem.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-hero-muted leading-relaxed max-w-3xl mx-auto">
              Our purpose is clear: to ensure technology remains a force for good in an increasingly complex digital world.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-hero-foreground/10 backdrop-blur-sm border border-hero-foreground/20 rounded-2xl p-12 max-w-4xl mx-auto">
              ...
              <h3 className="text-3xl font-bold mb-6 text-hero-foreground">
                Our Core Belief
              </h3>
              
              <p className="text-xl text-hero-muted leading-relaxed mb-8">
                Technology should empower humanity, not endanger it. Every line of code we write, every security measure we implement, 
                and every threat we neutralize is guided by this fundamental principle.
              </p>
