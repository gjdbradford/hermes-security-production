        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='text-center'>
              ...
              <p className='text-muted-foreground'>
                We believe in doing what's right, not just what's profitable. Your security is our
                mission.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-muted-foreground'>
                Round-the-clock monitoring and support to ensure your digital assets are always
                protected.
              </p>
            </div>
          </div>
