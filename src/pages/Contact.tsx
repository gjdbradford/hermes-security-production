    ...
    return (
      <>
        <Helmet>
          ...
          <meta
            name='description'
            content="Thank you for contacting Hermes Security. We'll be in touch soon."
          />
        </Helmet>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Contact Hermes Security for expert cybersecurity services, penetration testing, and compliance solutions.'
        />
        <meta
          name='keywords'
          content='contact, cybersecurity, penetration testing, security consultation'
        />
      </Helmet>
        ...
        <div className='py-12'>
          <div className='container mx-auto px-4'>
            <div className='text-center mb-8'>
              <h1 className='text-4xl font-bold text-accent-security mb-4'>{ctaSource}</h1>
              <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
                Tell us your urgency and a little about your security needs and we'll get back to
                you ASAP!
              </p>
            </div>
