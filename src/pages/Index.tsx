  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='keywords'
          content='penetration testing, cybersecurity, AI security, ethical hacking, web app security, API security, cloud security, network security'
        />
        <meta property='og:title' content='Hermes Security - AI-Driven Penetration Testing' />
        <meta
          property='og:description'
          content='Enterprise-grade cybersecurity with AI speed and human oversight.'
        />
      ...
      <Suspense
        fallback={
          <div className='fixed top-0 w-full bg-hero/95 backdrop-blur-md z-50 h-16 flex items-center justify-center'>
            <div className='animate-spin rounded-full h-8 w-8 border-b-2 border-accent-security'></div>
          </div>
        }
      >
        <Header />
