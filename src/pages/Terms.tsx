            ...
            <Card>
              ...
              <CardContent className="prose prose-lg max-w-none">
                <div className="space-y-8">
                  ...
                  {/* Services */}
                  <section>
                    <h2 className="text-2xl font-semibold text-accent-security mb-4">3. Services</h2>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  {/* User Obligations */}
                  <section>
                    <h2 className="text-2xl font-semibold text-accent-security mb-4">4. User Obligations</h2>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <section>
                    <h2 className="text-2xl font-semibold text-accent-security mb-4">5. Service Level Agreement</h2>
                  ...
                  {/* Payment Terms */}
                  <section>
                    <h2 className="text-2xl font-semibold text-accent-security mb-4">6. Payment Terms</h2>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <section className="bg-gray-50 p-6 rounded-lg">
                    <h2 className="text-2xl font-semibold text-accent-security mb-4">12. Contact Information</h2>
