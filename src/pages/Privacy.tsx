...
import { ChevronRight, Home, Mail, Shield, UserCheck } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Privacy Policy for Hermes Security - Data processing and protection policies.'
        />
                ...
                <div className='space-y-8'>
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed'>
                      Hermes Security is committed to protecting your privacy and personal data in
                      accordance with applicable data protection laws and best practices.
                    </p>
                  ...
                  <section>
                    ...
                    <div className='bg-blue-50 p-4 rounded-lg'>
                      ...
                      <p className='text-blue-800'>
                        <strong>Email:</strong> graham@hermessecurity.io
                      </p>
                      <p className='text-blue-800'>
                  ...
                  <section>
                    ...
                    <ul className='list-disc list-inside text-gray-700 space-y-2'>
                      <li>
                        <strong>Consent:</strong> When you provide explicit consent for data
                        processing
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Legitimate Interest:</strong> For business operations and service
                        improvement
                      </li>
                      <li>
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed mt-4'>
                      <strong>Important:</strong> We use your data for sales and onboarding purposes
                      only. We do not use your personal data for any other purposes without your
                      explicit consent.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <ul className='list-disc list-inside text-gray-700 mt-4 space-y-2'>
                      <li>
                        Service providers who assist in our operations (under strict data protection
                        agreements)
                      </li>
                    ...
                    <div className='bg-yellow-50 p-4 rounded-lg mt-4'>
                      <p className='text-yellow-800'>
                        <strong>Data Transfers:</strong> Any international transfers are protected
                        by appropriate safeguards including Standard Contractual Clauses (SCCs) and
                        adequacy decisions.
                      </p>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed mt-4'>
                      Data is automatically deleted after the retention period unless legal
                  ...
                  <section>
                    ...
                    <div className='bg-gray-50 p-4 rounded-lg mt-4'>
                      ...
                      <ul className='text-gray-700 space-y-1'>
                        ...
                        <li>
                          • <strong>Marketing:</strong> Only with your consent
                        </li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed'>
                      In the unlikely event of a data breach that poses a risk to your rights and
                      freedoms, we will notify you and the relevant authorities as required by
                      applicable laws.
                    </p>
                  </section>
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed'>
                      ...
                      supervisory authority if you believe we have not handled your personal data in
                  ...
                  <section>
                    ...
                    <p className='text-gray-700 leading-relaxed'>
                      ...
                      this page with an updated revision date. We will notify you of significant
